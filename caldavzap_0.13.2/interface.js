...
function items(etag, from, end, title, isall, uid, rid, ev_id, note, displayValue, alertTime, alertNote, untilDate, type, interval, after, repeatStart, repeatEnd, byMonthDay, repeatCount, realRepeatCount, vcalendar, location, categories, alertTimeOut, timeZone, realStart ,realEnd, byDay, rec_id, wkst, classType, avail, hrefUrl,compareString,priority,status,ruleString)
{
	this.etag=etag;
	this.id=uid;
	this.start=from;
...
// EVENTS
	...
	$('[data-type="categories"]').text(localization[globalInterfaceLanguage].txtCategories);
	$('[data-type="categories_NONE"]').text(localization[globalInterfaceLanguage].txtCategoriesNONE);
	$('[data-type="categories_Anniversary"]').text(localization[globalInterfaceLanguage].txtCategoriesAnniversary);
	$('[data-type="categories_Birthday"]').text(localization[globalInterfaceLanguage].txtCategoriesBirthday);
	$('[data-type="categories_Business"]').text(localization[globalInterfaceLanguage].txtCategoriesBusiness);
	$('[data-type="categories_Calls"]').text(localization[globalInterfaceLanguage].txtCategoriesCalls);
	$('[data-type="categories_Car"]').text(localization[globalInterfaceLanguage].txtCategoriesCar);
	$('[data-type="categories_Clients"]').text(localization[globalInterfaceLanguage].txtCategoriesClients);
	$('[data-type="categories_Competition"]').text(localization[globalInterfaceLanguage].txtCategoriesCompetition);
	$('[data-type="categories_Customer"]').text(localization[globalInterfaceLanguage].txtCategoriesCustomer);
	$('[data-type="categories_Default"]').text(localization[globalInterfaceLanguage].txtCategoriesDefault);
	$('[data-type="categories_Exam"]').text(localization[globalInterfaceLanguage].txtCategoriesExam);
	$('[data-type="categories_Favorites"]').text(localization[globalInterfaceLanguage].txtCategoriesFavorites);
	$('[data-type="categories_Follow_up"]').text(localization[globalInterfaceLanguage].txtCategoriesFollow_up);
	$('[data-type="categories_Gifts"]').text(localization[globalInterfaceLanguage].txtCategoriesGifts);
	$('[data-type="categories_Health"]').text(localization[globalInterfaceLanguage].txtCategoriesHealth);
	$('[data-type="categories_Holidays"]').text(localization[globalInterfaceLanguage].txtCategoriesHolidays);
	$('[data-type="categories_Ideas"]').text(localization[globalInterfaceLanguage].txtCategoriesIdeas);
	$('[data-type="categories_Important"]').text(localization[globalInterfaceLanguage].txtCategoriesImportant);
	$('[data-type="categories_Issues"]').text(localization[globalInterfaceLanguage].txtCategoriesIssues);
	$('[data-type="categories_Medical"]').text(localization[globalInterfaceLanguage].txtCategoriesMedical);
	$('[data-type="categories_Meeting"]').text(localization[globalInterfaceLanguage].txtCategoriesMeeting);
	$('[data-type="categories_Miscellaneous"]').text(localization[globalInterfaceLanguage].txtCategoriesMiscellaneous);
	$('[data-type="categories_Movie"]').text(localization[globalInterfaceLanguage].txtCategoriesMovie);
	$('[data-type="categories_Music"]').text(localization[globalInterfaceLanguage].txtCategoriesMusic);
	$('[data-type="categories_Party"]').text(localization[globalInterfaceLanguage].txtCategoriesParty);
	$('[data-type="categories_Personal"]').text(localization[globalInterfaceLanguage].txtCategoriesPersonal);
	$('[data-type="categories_Pets"]').text(localization[globalInterfaceLanguage].txtCategoriesPets);
	$('[data-type="categories_Projects"]').text(localization[globalInterfaceLanguage].txtCategoriesProjects);
	$('[data-type="categories_Public_Holiday"]').text(localization[globalInterfaceLanguage].txtCategoriesPublic_Holiday);
	$('[data-type="categories_School"]').text(localization[globalInterfaceLanguage].txtCategoriesSchool);
	$('[data-type="categories_Sport"]').text(localization[globalInterfaceLanguage].txtCategoriesSport);
	$('[data-type="categories_Status"]').text(localization[globalInterfaceLanguage].txtCategoriesStatus);
	$('[data-type="categories_Suppliers"]').text(localization[globalInterfaceLanguage].txtCategoriesSuppliers);
	$('[data-type="categories_Theater"]').text(localization[globalInterfaceLanguage].txtCategoriesTheater);
	$('[data-type="categories_Travel"]').text(localization[globalInterfaceLanguage].txtCategoriesTravel);
	$('[data-type="categories_Trip"]').text(localization[globalInterfaceLanguage].txtCategoriesTrip);
	$('[data-type="categories_TV"]').text(localization[globalInterfaceLanguage].txtCategoriesTV);
	$('[data-type="categories_Urgent"]').text(localization[globalInterfaceLanguage].txtCategoriesUrgent);
	$('[data-type="categories_Vacation"]').text(localization[globalInterfaceLanguage].txtCategoriesVacation);
	$('[data-type="categories_Work"]').text(localization[globalInterfaceLanguage].txtCategoriesWork);
	$('[data-type="categories_Red_Category"]').text(localization[globalInterfaceLanguage].txtCategoriesRed_Category);
	$('[data-type="categories_Blue_Category"]').text(localization[globalInterfaceLanguage].txtCategoriesBlue_Category);
	$('[data-type="categories_Green_Category"]').text(localization[globalInterfaceLanguage].txtCategoriesGreen_Category);
	$('[data-type="categories_Orange_Category"]').text(localization[globalInterfaceLanguage].txtCategoriesOrange_Category);
	$('[data-type="categories_Purple_Category"]').text(localization[globalInterfaceLanguage].txtCategoriesPurple_Category);
	$('[data-type="categories_Yellow_Category"]').text(localization[globalInterfaceLanguage].txtCategoriesYellow_Category);
	$('[data-type="PH_categories"]').attr('placeholder',localization[globalInterfaceLanguage].pholderCategories);
	$('[data-type="PH_categories_NONE"]').text(localization[globalInterfaceLanguage].pholderCategoriesNONE);
	$('[data-type="PH_categories_Anniversary"]').text(localization[globalInterfaceLanguage].pholderCategoriesAnniversary);
	$('[data-type="PH_categories_Birthday"]').text(localization[globalInterfaceLanguage].pholderCategoriesBirthday);
	$('[data-type="PH_categories_Business"]').text(localization[globalInterfaceLanguage].pholderCategoriesBusiness);
	$('[data-type="PH_categories_Calls"]').text(localization[globalInterfaceLanguage].pholderCategoriesCalls);
	$('[data-type="PH_categories_Car"]').text(localization[globalInterfaceLanguage].pholderCategoriesCar);
	$('[data-type="PH_categories_Clients"]').text(localization[globalInterfaceLanguage].pholderCategoriesClients);
	$('[data-type="PH_categories_Competition"]').text(localization[globalInterfaceLanguage].pholderCategoriesCompetition);
	$('[data-type="PH_categories_Customer"]').text(localization[globalInterfaceLanguage].pholderCategoriesCustomer);
	$('[data-type="PH_categories_Default"]').text(localization[globalInterfaceLanguage].pholderCategoriesDefault);
	$('[data-type="PH_categories_Exam"]').text(localization[globalInterfaceLanguage].pholderCategoriesExam);
	$('[data-type="PH_categories_Favorites"]').text(localization[globalInterfaceLanguage].pholderCategoriesFavorites);
	$('[data-type="PH_categories_Follow_up"]').text(localization[globalInterfaceLanguage].pholderCategoriesFollow_up);
	$('[data-type="PH_categories_Gifts"]').text(localization[globalInterfaceLanguage].pholderCategoriesGifts);
	$('[data-type="PH_categories_Health"]').text(localization[globalInterfaceLanguage].pholderCategoriesHealth);
	$('[data-type="PH_categories_Holidays"]').text(localization[globalInterfaceLanguage].pholderCategoriesHolidays);
	$('[data-type="PH_categories_Ideas"]').text(localization[globalInterfaceLanguage].pholderCategoriesIdeas);
	$('[data-type="PH_categories_Important"]').text(localization[globalInterfaceLanguage].pholderCategoriesImportant);
	$('[data-type="PH_categories_Issues"]').text(localization[globalInterfaceLanguage].pholderCategoriesIssues);
	$('[data-type="PH_categories_Medical"]').text(localization[globalInterfaceLanguage].pholderCategoriesMedical);
	$('[data-type="PH_categories_Meeting"]').text(localization[globalInterfaceLanguage].pholderCategoriesMeeting);
	$('[data-type="PH_categories_Miscellaneous"]').text(localization[globalInterfaceLanguage].pholderCategoriesMiscellaneous);
	$('[data-type="PH_categories_Movie"]').text(localization[globalInterfaceLanguage].pholderCategoriesMovie);
	$('[data-type="PH_categories_Music"]').text(localization[globalInterfaceLanguage].pholderCategoriesMusic);
	$('[data-type="PH_categories_Party"]').text(localization[globalInterfaceLanguage].pholderCategoriesParty);
	$('[data-type="PH_categories_Personal"]').text(localization[globalInterfaceLanguage].pholderCategoriesPersonal);
	$('[data-type="PH_categories_Pets"]').text(localization[globalInterfaceLanguage].pholderCategoriesPets);
	$('[data-type="PH_categories_Projects"]').text(localization[globalInterfaceLanguage].pholderCategoriesProjects);
	$('[data-type="PH_categories_Public_Holiday"]').text(localization[globalInterfaceLanguage].pholderCategoriesPublic_Holiday);
	$('[data-type="PH_categories_School"]').text(localization[globalInterfaceLanguage].pholderCategoriesSchool);
	$('[data-type="PH_categories_Sport"]').text(localization[globalInterfaceLanguage].pholderCategoriesSport);
	$('[data-type="PH_categories_Status"]').text(localization[globalInterfaceLanguage].pholderCategoriesStatus);
	$('[data-type="PH_categories_Suppliers"]').text(localization[globalInterfaceLanguage].pholderCategoriesSuppliers);
	$('[data-type="PH_categories_Theater"]').text(localization[globalInterfaceLanguage].pholderCategoriesTheater);
	$('[data-type="PH_categories_Travel"]').text(localization[globalInterfaceLanguage].pholderCategoriesTravel);
	$('[data-type="PH_categories_Trip"]').text(localization[globalInterfaceLanguage].pholderCategoriesTrip);
	$('[data-type="PH_categories_TV"]').text(localization[globalInterfaceLanguage].pholderCategoriesTV);
	$('[data-type="PH_categories_Urgent"]').text(localization[globalInterfaceLanguage].pholderCategoriesUrgent);
	$('[data-type="PH_categories_Vacation"]').text(localization[globalInterfaceLanguage].pholderCategoriesVacation);
	$('[data-type="PH_categories_Work"]').text(localization[globalInterfaceLanguage].pholderCategoriesWork);
	$('[data-type="PH_categories_Red_Category"]').text(localization[globalInterfaceLanguage].pholderCategoriesRed_Category);
	$('[data-type="PH_categories_Blue_Category"]').text(localization[globalInterfaceLanguage].pholderCategoriesBlue_Category);
	$('[data-type="PH_categories_Green_Category"]').text(localization[globalInterfaceLanguage].pholderCategoriesGreen_Category);
	$('[data-type="PH_categories_Orange_Category"]').text(localization[globalInterfaceLanguage].pholderCategoriesOrange_Category);
	$('[data-type="PH_categories_Purple_Category"]').text(localization[globalInterfaceLanguage].pholderCategoriesPurple_Category);
	$('[data-type="PH_categories_Yellow_Category"]').text(localization[globalInterfaceLanguage].pholderCategoriesYellow_Category);
	...
	$('#CalDavZAPPopup').find('[data-type="categories_txt"]').text(localization[globalInterfaceLanguage].txtCategories);
...
function showEventPopup(e, event)
{
	...
	if(event.categories=='')
		$('#CalDavZAPPopup').find('[data-type="categories"]').parent().css('display','none');
	else
		$('#CalDavZAPPopup').find('[data-type="categories"]').text(event.categories).parent().css('display','');
	if(event.hrefUrl=='')
