...
vCalendar.re['contentline_CATEGORIES']='(?:'+vCalendar.re['group']+'\\.)?CATEGORIES(?:;'+vCalendar.re['text-param']+')*:'+vCalendar.re['text-value']+vCalendar.re['CRLF'];
vCalendar.pre['contentline_CATEGORIES']=RegExp('\r\n'+vCalendar.re['contentline_CATEGORIES'],'mi');
...
vCalendar.tplC['contentline_CATEGORIES']='##:::##group_wd##:::##CATEGORIES##:::##params_wsc##:::##:##:::##value##:::##\r\n';
vCalendar.tplM['contentline_CATEGORIES']=new Array();
...
vCalendar.tplC['VTcontentline_CATEGORIES']='##:::##group_wd##:::##CATEGORIES##:::##params_wsc##:::##:##:::##value##:::##\r\n';
vCalendar.tplM['VTcontentline_CATEGORIES']={};
