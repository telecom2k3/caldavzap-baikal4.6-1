...
var defaults = {
	...
	todoCols: ['handle', 'check', 'priority', 'time', 'title', 'location', 'categories', 'status', 'percent'],
	todoColThresholds: [],
	todoOptionalCols: [],
...
function AgendaEventRenderer() {
	...
	function slotSegHtml(event, seg) {
		...
		if (event.categories=='Red Category') {
			html +=
				" class='" + classes.join(' ') + "'" +
				" style='position:absolute;z-index:8;top:" + seg.top + "px;left:" + seg.left + "px;" + skinCss + "'" +
				">" +
				"<div class='fc-event-inner-red fc-event-skin'" + skinCssAttr + ">" +
				...
				"</div>"; // close inner
		} else if (event.categories=='Blue Category') {
			html +=
				" class='" + classes.join(' ') + "'" +
				" style='position:absolute;z-index:8;top:" + seg.top + "px;left:" + seg.left + "px;" + skinCss + "'" +
				">" +
				"<div class='fc-event-inner-blue fc-event-skin'" + skinCssAttr + ">" +
				"<div class='fc-event-head fc-event-skin'" + skinCssAttr + ">" +
				"<div class='fc-event-time'>" +
				htmlEscape(formatDates(event.start, event.end, opt('timeFormat'))) +
				"</div>" +
				...
				"<div class='fc-event-bg'></div>" +
				"</div>"; // close inner
		} else if (event.categories=='Green Category') {
			html +=
				" class='" + classes.join(' ') + "'" +
				" style='position:absolute;z-index:8;top:" + seg.top + "px;left:" + seg.left + "px;" + skinCss + "'" +
				">" +
				"<div class='fc-event-inner-green fc-event-skin'" + skinCssAttr + ">" +
				"<div class='fc-event-head fc-event-skin'" + skinCssAttr + ">" +
				"<div class='fc-event-time'>" +
				htmlEscape(formatDates(event.start, event.end, opt('timeFormat'))) +
				"</div>" +
				...
				"<div class='fc-event-bg'></div>" +
				"</div>"; // close inner
		} else if (event.categories=='Orange Category') {
			html +=
				" class='" + classes.join(' ') + "'" +
				" style='position:absolute;z-index:8;top:" + seg.top + "px;left:" + seg.left + "px;" + skinCss + "'" +
				">" +
				"<div class='fc-event-inner-orange fc-event-skin'" + skinCssAttr + ">" +
				"<div class='fc-event-head fc-event-skin'" + skinCssAttr + ">" +
				"<div class='fc-event-time'>" +
				htmlEscape(formatDates(event.start, event.end, opt('timeFormat'))) +
				"</div>" +
				...
				"<div class='fc-event-bg'></div>" +
				"</div>"; // close inner
		} else if (event.categories=='Purple Category') {
			html +=
				" class='" + classes.join(' ') + "'" +
				" style='position:absolute;z-index:8;top:" + seg.top + "px;left:" + seg.left + "px;" + skinCss + "'" +
				">" +
				"<div class='fc-event-inner-purple fc-event-skin'" + skinCssAttr + ">" +
				"<div class='fc-event-head fc-event-skin'" + skinCssAttr + ">" +
				"<div class='fc-event-time'>" +
				htmlEscape(formatDates(event.start, event.end, opt('timeFormat'))) +
				"</div>" +
				...
				"<div class='fc-event-bg'></div>" +
				"</div>"; // close inner
		} else if (event.categories=='Yellow Category') {
			html +=
				" class='" + classes.join(' ') + "'" +
				" style='position:absolute;z-index:8;top:" + seg.top + "px;left:" + seg.left + "px;" + skinCss + "'" +
				">" +
				"<div class='fc-event-inner-yellow fc-event-skin'" + skinCssAttr + ">" +
				"<div class='fc-event-head fc-event-skin'" + skinCssAttr + ">" +
				"<div class='fc-event-time'>" +
				htmlEscape(formatDates(event.start, event.end, opt('timeFormat'))) +
				"</div>" +
		...
		for (i=0; i<segCnt; i++) {
			...
			if (event.categories=='Red Category') {
				html +=
					...
					">" +
					"<div" +
					" class='fc-event-inner-red fc-event-skin'" +
				 ...
				 html +=
					...
					">" +
					"<div" +
					" class='fc-event-inner-blue fc-event-skin'" +
					" style='width:" + titleWidth + "px;z-index:inherit;" +
					(skinCss ? skinCss : '') +
					"'" +
					//(skinCss ? " style='" + skinCss + "'" : '') +
				 ...
				 html +=
					...
					">" +
					"<div" +
					" class='fc-event-inner-green fc-event-skin'" +
					" style='width:" + titleWidth + "px;z-index:inherit;" +
					(skinCss ? skinCss : '') +
					"'" +
					//(skinCss ? " style='" + skinCss + "'" : '') +
				 ...
				 html +=
					...
					">" +
					"<div" +
					" class='fc-event-inner-orange fc-event-skin'" +
					" style='width:" + titleWidth + "px;z-index:inherit;" +
					(skinCss ? skinCss : '') +
					"'" +
					//(skinCss ? " style='" + skinCss + "'" : '') +
				 ...
				 html +=
					...
					">" +
					"<div" +
					" class='fc-event-inner-purple fc-event-skin'" +
					" style='width:" + titleWidth + "px;z-index:inherit;" +
					(skinCss ? skinCss : '') +
					"'" +
					//(skinCss ? " style='" + skinCss + "'" : '') +
				 ...
				 html +=
					...
					">" +
					"<div" +
					" class='fc-event-inner-yellow fc-event-skin'" +
					" style='width:" + titleWidth + "px;z-index:inherit;" +
					(skinCss ? skinCss : '') +
					"'" +
					//(skinCss ? " style='" + skinCss + "'" : '') +
