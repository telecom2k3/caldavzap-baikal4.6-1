...
// Replace YOUR_HOST.DOMAIN.TLD with the your Baikal Server's DNS address
// Replace the hrefLabel parameter with the name you'd like to calendar to display within the CalDavZAP frame in Roundcube.  The default is "Baikal".
var globalNetworkCheckSettings={href:'https://YOUR_HOST.DOMAIN.TLD/cal.php/principals/',
	timeOut: 30000,
	checkContentType: true,
	settingsAccount: true,
	delegation: false,
...
//var globalNetworkAccountSettings={href: 'https://'+location.hostname+'/calendar/auth/index.php',
//	timeOut: 30000
//	checkContentType: true,
//	settingsAccount: true,
//	delegation: false,
...
var globalCalendarEndOfBusiness=18;
...
// Example:
var globalDefaultEventDuration=30;
...
var globalTimeZonesEnabled=['America/New_York'];
...
// var globalSubscribedCalendars={
	...
	// calendars: [
		// {
			// href: 'https://www.ferienwiki.de/exports/ferien/2017/de/bayern',
			// userAuth: {
				// userName: '',
				// userPassword: ''
			// },
			// typeList: ['vevent'],
			// ignoreAlarm: true,
			// displayName: 'Ferien Bayern 2017',
			// color: '#19c10e'
		// },
		// {
			// href: 'https://www.ferienwiki.de/exports/feiertage/2017/de/bayern',
			// userAuth: {
				// userName: '',
				// userPassword: '',
			// },
